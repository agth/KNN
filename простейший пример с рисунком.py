...
#plt.title("новая точка %s принадлежит классу = %i", new_tochka, clas) # вывожу на экран к какому классу принадлежит данная точка
plt.title("новая точка %s принадлежит классу %i"% (new_tochka, clas))#отрисовка заголовка
