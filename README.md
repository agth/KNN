...
3. Напишу более сложный пример. Он будет раскрашивать всю плоскость так, что куда бы не тыкнули новую точку, было бы известно к какому классу она будет относится.
