...
#при прогнозировании к какому классу относится участок можно 
#использовать различные параметры весовой функции
#'uniform' означает равномерную фесовую функцию. 
#Рассояние от классифицируемого объекта до заданных точек не учитываеется
...
#классифицируемого объекта но и расстояние на котором они расположены до
